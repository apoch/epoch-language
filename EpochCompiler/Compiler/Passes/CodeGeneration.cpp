...
namespace
{
	...
	void Generate(const IRSemantics::CodeBlock& codeblock, const IRSemantics::Namespace& curnamespace, BytecodeEmitterBase& emitter);
	void EmitStatement(BytecodeEmitterBase& emitter, const IRSemantics::Statement& statement, const IRSemantics::CodeBlock& activescope, const IRSemantics::Namespace& curnamespace);
	void EmitExpression(BytecodeEmitterBase& emitter, const IRSemantics::Expression& expression, const IRSemantics::CodeBlock& activescope, const IRSemantics::Namespace& curnamespace, bool constructssumtype = false, bool constructorcall = false);
	...
	void FastInvoke(BytecodeEmitterBase& emitter, const IRSemantics::Namespace& curnamespace, StringHandle funcname)
	{
	...
	void BindReference(BytecodeEmitterBase& emitter, const std::vector<StringHandle>& identifiers, const IRSemantics::Namespace& curnamespace, const IRSemantics::CodeBlock& activescope)
	{
	...
	void PushValue(BytecodeEmitterBase& emitter, const std::vector<StringHandle>& identifiers, const IRSemantics::Namespace& curnamespace, const IRSemantics::CodeBlock& activescope)
	{
		if(identifiers.empty())
		{
			//
	...
	void EmitPreOpStatement(BytecodeEmitterBase& emitter, const IRSemantics::PreOpStatement& statement, const IRSemantics::CodeBlock& codeblock, const IRSemantics::Namespace& curnamespace, bool pushafterwrite)
	{
	...
	void EmitPostOpStatement(BytecodeEmitterBase& emitter, const IRSemantics::PostOpStatement& statement, const IRSemantics::CodeBlock& codeblock, const IRSemantics::Namespace& curnamespace, bool pushafterwrite)
	{
	...
	bool EmitExpressionAtom(BytecodeEmitterBase& emitter, const IRSemantics::ExpressionAtom* rawatom, const IRSemantics::CodeBlock& activescope, const IRSemantics::Namespace& curnamespace, bool firstmember, bool constructorcall)
	{
		if(!rawatom)
		{
			//
	...
	void EmitExpression(BytecodeEmitterBase& emitter, const IRSemantics::Expression& expression, const IRSemantics::CodeBlock& activescope, const IRSemantics::Namespace& curnamespace, bool constructssumtype, bool constructorcall)
	{
	...
	void GenerateAssignment(BytecodeEmitterBase& emitter, const IRSemantics::Assignment& assignment, const IRSemantics::Namespace& curnamespace, const IRSemantics::CodeBlock& activescope)
	{
		bool pushlhs = false;
	...
	void Generate(const IRSemantics::Entity& entity, const IRSemantics::Namespace& curnamespace, const IRSemantics::CodeBlock& activescope, BytecodeEmitterBase& emitter)
	{
			...
			for(IRSemantics::InstancesAndArguments::const_iterator institer = instances.begin(); institer != instances.end(); ++institer)
			{
				...
				for(std::vector<std::pair<StringHandle, IRSemantics::StructureMember*> >::const_iterator memberiter = members.begin(); memberiter != members.end(); ++memberiter)
				{
					...
					/*else if(Metadata::GetTypeFamily(membertype) == Metadata::EpochTypeFamily_SumType)
					{
						...
						{
							if(Metadata::IsStructureType(*baseiter))
								structuredependencies.AddDependency(type, *baseiter);
						}
					}*/
				}
			}
