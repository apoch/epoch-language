...
const unsigned char Bytecode::ConsArray					= 0x56;
const unsigned char Bytecode::FunctionSignatureList		= 0x57;
const unsigned char Bytecode::FunctionSignatureBegin	= 0x58;
const unsigned char Bytecode::FunctionSignatureEnd		= 0x59;
const unsigned char Bytecode::ForkTask					= 0x5a;
const unsigned char Bytecode::ResponseMaps				= 0x5b;
const unsigned char Bytecode::AcceptMessage				= 0x5c;
const unsigned char Bytecode::MultiplyIntegers			= 0x5d;
const unsigned char Bytecode::GetMessageSender			= 0x5e;
const unsigned char Bytecode::GetTaskCaller				= 0x5f;
const unsigned char Bytecode::SendTaskMessage			= 0x60;
const unsigned char Bytecode::AcceptMessageFromMap		= 0x61;
const unsigned char Bytecode::DebugCrashVM				= 0x62;
const unsigned char Bytecode::Future					= 0x63;
const unsigned char Bytecode::Map						= 0x64;
const unsigned char Bytecode::Reduce					= 0x65;
const unsigned char Bytecode::IntegerLiteral			= 0x66;
const unsigned char Bytecode::ArrayTypes				= 0x67;
const unsigned char Bytecode::ArraySizes				= 0x68;
