...
namespace EpochVSIX
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Epoch", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension)]
