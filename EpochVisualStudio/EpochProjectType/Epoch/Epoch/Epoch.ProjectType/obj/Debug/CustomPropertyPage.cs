...
namespace EpochVS {
	...
	internal partial class MyCustomPropertyPage {
		...
		internal const string SchemaName = "MyCustomPropertyPage";
		...
		/// <summary> (The "SomeProperty" property).</summary>
		internal const string SomePropertyProperty = "SomeProperty";
		...
		/// <summary>Initializes a new instance of the MyCustomPropertyPage class.</summary>
		internal MyCustomPropertyPage(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs, string context, string file, string itemType, string itemName) : 
		...
		internal Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty SomeProperty {
			get {
				...
				Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(SomePropertyProperty)));
				if (((property == null) 
							&& (this.GeneratedFallbackRule != null))) {
					localRule = this.GeneratedFallbackRule;
					property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(SomePropertyProperty)));
				}
				return property;
			}
		}
		...
		private void InitializeFallbackRule() {
			...
			Microsoft.Build.Framework.XamlTypes.Rule unboundRule = MyCustomPropertyPage.deserializedFallbackRule;
			if ((unboundRule == null)) {
				System.IO.Stream xamlStream = null;
				System.Reflection.Assembly thisAssembly = System.Reflection.Assembly.GetExecutingAssembly();
				try {
					xamlStream = thisAssembly.GetManifestResourceStream("XamlRuleToCode:CustomPropertyPage.xaml");
					...
					; ((unboundRule == null) 
						...
						if (System.StringComparer.OrdinalIgnoreCase.Equals(t.Name, SchemaName)) {
							unboundRule = t;
							unboundRule.Name = "5d41bafd-1157-4025-88b8-ae7b27a47b11";
							MyCustomPropertyPage.deserializedFallbackRule = unboundRule;
						}
					}
				}
				finally {
