...
namespace EpochVS {
	...
	internal partial class None {
		...
		/// <summary>Initializes a new instance of the None class.</summary>
		internal None(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule, Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject) : 
				this(rule) {
			if ((rule == null)) {
		...
		private void InitializeFallbackRule() {
			...
			Microsoft.Build.Framework.XamlTypes.Rule unboundRule = None.deserializedFallbackRule;
			if ((unboundRule == null)) {
				System.IO.Stream xamlStream = null;
				System.Reflection.Assembly thisAssembly = System.Reflection.Assembly.GetExecutingAssembly();
				try {
					xamlStream = thisAssembly.GetManifestResourceStream("XamlRuleToCode:none.xaml");
					...
					; ((unboundRule == null) 
						...
						if (System.StringComparer.OrdinalIgnoreCase.Equals(t.Name, SchemaName)) {
							unboundRule = t;
							unboundRule.Name = "83a8cabb-b296-47f7-95f8-3120f74d0656";
							None.deserializedFallbackRule = unboundRule;
						}
					}
				}
				finally {
