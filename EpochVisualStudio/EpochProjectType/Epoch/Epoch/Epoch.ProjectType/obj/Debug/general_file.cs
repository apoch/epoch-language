...
namespace EpochVS {
	...
	internal partial class ConfigurationGeneralFile {
		...
		/// <summary>Initializes a new instance of the ConfigurationGeneralFile class.</summary>
		internal ConfigurationGeneralFile(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule, Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject) : 
				this(rule) {
			if ((rule == null)) {
		...
		internal Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty ItemType {
			get {
				...
				if (((property == null) 
					...
					localRule = this.GeneratedFallbackRule;
					property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(ItemTypeProperty)));
				}
				return property;
			}
		}
		...
		private void InitializeFallbackRule() {
			...
			Microsoft.Build.Framework.XamlTypes.Rule unboundRule = ConfigurationGeneralFile.deserializedFallbackRule;
			if ((unboundRule == null)) {
				System.IO.Stream xamlStream = null;
				System.Reflection.Assembly thisAssembly = System.Reflection.Assembly.GetExecutingAssembly();
				try {
					xamlStream = thisAssembly.GetManifestResourceStream("XamlRuleToCode:general_file.xaml");
					...
					; ((unboundRule == null) 
						...
						if (System.StringComparer.OrdinalIgnoreCase.Equals(t.Name, SchemaName)) {
							unboundRule = t;
							unboundRule.Name = "695b63bc-e128-47f2-ae30-243b34e6c7f4";
